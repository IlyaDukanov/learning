...
class Application(Frame):
	...
	def create_widgets(self):
		...
		Label(self,
			text = 'Выберите прилагательное (-ые): '
		...
		''':::Text area:::'''
		self.story_txt = Text(width = 75, height = 10, wrap = WORD)
	...
	def tell_story(self):
		...
		story += person
		story += ' уже совсем отчаялся и решил довершить дело своей жизни - найти затерянный город, в котором, по легенде, обитали '
		story += noun.title()
		story += '. Но однажды '
		story += noun
		story += ' и '
		...
		story += 'После стольких лет поиска цель была достигнута. '
		story += person
